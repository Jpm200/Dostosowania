...
<body>
    ...
    ?>
        <table class="Adminmenu2">
            <tr class="Adminmenu3">
                ...
                <td class="Adminmenu4"><a href="SuperAdminNpspr.php">Npspr</a></td>
    ...
    <div class="dodawanie">
                <form action="SuperAdminNpspr.php" method="post" id="dodaj">
                        Nazwa :<br> <input name="nazwa"><br>
                        <input name="dodaj" type="hidden" value="1">
                        <button class="button-13" onClick="dodajNpspr()">Dodaj</button>                                                             
                </form>
            </div>
<?php         
                ...
                if($result){
                    while($row = mysqli_fetch_array($result)){
                        ...
                        <tr><form action="SuperAdminNpspr.php" method="post" id="'.$row['id_npspr'].'">
                        ...
                        <td class="'.$klasa.'" >
                        <button class="button-13" onClick="usunNpspr('.$row['id_npspr'].')">Usuń</button>
                        <button class="button-13" onClick="zapiszNpspr('.$row['id_npspr'].')">Zapisz</button>
                        </form></td>
                        </tr>
                        </table>
                        </div>';
