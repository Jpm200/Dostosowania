...
--
-- Host: 127.0.0.1
-- Generation Time: Cze 23, 2024 at 04:49 PM
...
(17, 'Zespół aspergera'),
(18, 'Afazja'),
(19, 'zagrożenie niedostosowaniem społecznym'),
(20, 'Niepełnosprawność ruchowa'),
(21, 'Autyzm');
...
(2, 'Karol', 'Łoś', 2, '2023/2024'),
(5, 'Maria', 'Kornik', 4, '2023/2024'),
(45, 'Anna', 'Muł', 5, '2023/2024'),
(46, 'Beata', 'Buk', 3, '2023/2024'),
(127, 'Marcin', 'Mak', 2, '2023/2024');
...
(470, 8, 4, '|7', '58|59|75|', 'FKJFKSJDFBSHBKSDJ', '18/06/2024 10:12', '2023/2024'),
(492, 8, 4, '|8', '74|75|65|69|', 'nnnd', '20/06/2024 13:58', '2023/2024'),
(494, 8, 4, '|3', '71|75|74|', '', '22/06/2024 19:21', '2023/2024'),
(495, 8, 4, '|2', '65|69|75|74|', '', '22/06/2024 19:23', '2023/2024'),
(497, 8, 4, '|7', '75|74|65|69|', '', '22/06/2024 19:27', '2023/2024'),
(499, 7, 4, '', '', '', '22/06/2024 20:45', '2023/2024'),
(500, 7, 4, '', '', '', '22/06/2024 20:46', '2023/2024'),
(501, 7, 4, '', '', '', '22/06/2024 20:46', '2023/2024'),
(502, 7, 4, '', '', '', '22/06/2024 20:51', '2023/2024'),
(503, 7, 4, '', '', '', '22/06/2024 20:51', '2023/2024'),
(504, 8, 5, '|2', '75|', 'gffg', '23/06/2024 15:59', '2023/2024'),
(505, 7, 5, '', '', '', '23/06/2024 16:06', '2023/2024'),
(506, 7, 5, '', '', '', '23/06/2024 16:07', '2023/2024'),
(507, 7, 5, '', '', '', '23/06/2024 16:07', '2023/2024'),
(508, 7, 5, '', '', '', '23/06/2024 16:08', '2023/2024'),
(509, 7, 5, '', '', '', '23/06/2024 16:08', '2023/2024'),
(510, 7, 5, '', '', '', '23/06/2024 16:09', '2023/2024'),
(511, 7, 5, '', '', '', '23/06/2024 16:09', '2023/2024'),
(512, 7, 5, '', '', '', '23/06/2024 16:15', '2023/2024'),
(513, 7, 5, '', '', '', '23/06/2024 16:23', '2023/2024'),
(514, 7, 5, '', '', '', '23/06/2024 16:24', '2023/2024'),
(515, 7, 5, '', '', '', '23/06/2024 16:25', '2023/2024'),
(516, 7, 5, '', '', '', '23/06/2024 16:30', '2023/2024');
...
(472, 8, 4, '|10', '', '', '17/06/2024 17:07', '2023/2024'),
(473, 8, 46, '|3', '65|', 'dfd', '17/06/2024 17:07', '2023/2024'),
(476, 8, 4, '|8', '', '', '17/06/2024 17:13', '2023/2025'),
(477, 8, 4, '', '', '', '17/06/2024 17:31', '2023/2024'),
(478, 8, 4, '', '', '', '17/06/2024 17:31', '2023/2024'),
(479, 8, 4, '|3', '', '', '17/06/2024 17:34', '2023/2024'),
(480, 8, 4, '|7', '', '', '17/06/2024 17:35', '2023/2024'),
(481, 8, 4, '', '', '', '17/06/2024 17:35', '2023/2024'),
(482, 8, 4, '', '', '', '17/06/2024 17:36', '2023/2024'),
(483, 8, 4, '', '', '', '17/06/2024 17:36', '2023/2024'),
(484, 8, 4, '', '', '', '17/06/2024 17:36', '2023/2024'),
(485, 8, 4, '|3|9|2', '61|60|', 'mkm', '18/06/2024 10:18', '2024/2025'),
(486, 8, 4, '|3', '', '', '19/06/2024 14:09', '2024/2025'),
(487, 8, 4, '|2', '', '', '19/06/2024 14:24', '2024/2025'),
(488, 8, 4, '|8|3|2|1|10|9|7', '61|60|59|', 'gg', '19/06/2024 17:52', '2024/2025');
...
--
ALTER TABLE `dostosowania`
  MODIFY `id_dost` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `klasy`
  MODIFY `id_klasa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `npspr`
--
ALTER TABLE `npspr`
  MODIFY `id_npspr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `przedmiot`
  MODIFY `id_przedmiot` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `uczniowie`
--
ALTER TABLE `uczniowie`
  MODIFY `id_ucznia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `zapisy`
  MODIFY `id_zapis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=517;

--
-- AUTO_INCREMENT for table `zapisy_archiwa`
--
ALTER TABLE `zapisy_archiwa`
  MODIFY `id_zapis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=489;
